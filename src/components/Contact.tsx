  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "duraijeeva2017@gmail.com",
      link: "mailto:duraijeeva2017@gmail.com"
    },
    {
      icon: <Linkedin className="w-6 h-6" />,
      label: "LinkedIn",
      value: "linkedin.com/in/durai-murugan-da",
      link: "https://linkedin.com/in/durai-murugan-da"
    },
    {
      icon: <Github className="w-6 h-6" />,
      label: "GitHub",
      value: "github.com/Durai-Murugan-DA",
      link: "https://github.com/Durai-Murugan-DA"
    }
  ];
