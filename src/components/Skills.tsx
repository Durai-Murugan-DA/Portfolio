  ...
  const skills = [
    {
      ...
      description: "Advanced dashboard creation and DAX functions"
    },
    {
      name: "SQL",
      level: 85,
      icon: <Database className="w-8 h-8 text-sky-600" />,
      description: "Complex queries, optimization, and data exploration"
    },
    {
      name: "Python",
      level: 80,
      icon: <Code className="w-8 h-8 text-sky-600" />,
      description: "Pandas, NumPy, machine learning with scikit-learn"
    },
    {
      name: "Data Visualization",
      level: 88,
      icon: <TrendingUp className="w-8 h-8 text-sky-600" />,
      description: "Tableau, Excel, and storytelling with data"
    }
  ];
